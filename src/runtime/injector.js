define(function(require,exports,module){
    ...
    var uglifyjs = require("../../vendor/uglify-js/uglify-js");
    ...
    var deparse = function (ast, b) {
        return uglifyjs.uglify.gen_code(ast, { beautify : b });
    };



    var injector = module.exports = function (code, cb) {
...
//        console.log(JSON.stringify(ast_,"  ",2));
//        console.log(deparse(ast_));
//        console.log(parse(deparse(ast_)));

        return deparse(parse(deparse(ast_)), true);
    };

    injector.parse = parse;
    injector.deparse = deparse;
    ...
    injector.generateName = function (len) {
        var name = '';
